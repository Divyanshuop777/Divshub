...
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		...
		<meta property="og:url" content="http://divshub.tk/imsearch.php" />
		<meta property="og:title" content="Search" />
		<meta property="og:site_name" content="Divshub" />
		<meta property="og:image" content="http://divshub.tk/favImage.png" />
		...
		<link rel="stylesheet" type="text/css" href="pcss/imsearch.css?14-0-6-1-637987042346379842" media="screen,print" />
		...
		<link rel="icon" href="favicon.png?14-0-6-1-637987042346319985" type="image/png" />
	</head>
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<div id="imHeader">
						<h1 class="imHidden">Search - Divshub</h1>
            ...
            <div id="soc_imHeader_pluginAppObj_02">
                <div class="wrapper horizontal flat none">
                	<div class='social-icon flat'><a href='#' target='_blank'><svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><g><path d="M89.2,34S88.42,28.49,86,26.06c-3-3.19-6.45-3.14-8-3.32C66.81,21.93,50,22,50,22h0s-16.79-.07-28,0.74c-1.56.19-5,.17-8,3.36C11.58,28.53,10.8,34,10.8,34A120.47,120.47,0,0,0,10,47V53A121,121,0,0,0,10.8,66s0.78,5.51,3.18,7.94c3,3.19,7,3.09,8.82,3.42,6.4,0.61,27.2.8,27.2,0.8s16.81,0,28-.83a11.44,11.44,0,0,0,8-3.39C88.42,71.48,89.2,66,89.2,66A121.16,121.16,0,0,0,90,53V47A121.16,121.16,0,0,0,89.2,34ZM41.74,60.38V37.9L63.35,49.18Z"/></g></svg><span class='fallbacktext'>Yt</span></a></div>
                </div>
...
</div></div></div><div id="imHeader_pluginAppObj_19_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_19"></div></div><div id="imHeader_imObjectTitle_21_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_21" class="" > <div id="imHeader_imCellStyleGraphics_21"></div><div id="imHeader_imCellStyle_21" ><h1 id="imHeader_imObjectTitle_21"><span id ="imHeader_imObjectTitle_21_text" >DIV'SHUB</span > </h1></div></div></div></div>
					</div>
...
$(function () {$('#imStickyBar_imMenuObject_01 ul li').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_01-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_01-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
...
</div></div></div><div id="imStickyBar_imObjectTitle_02_wrapper" class="template-object-wrapper"><div id="imStickyBar_imCell_2" class="" > <div id="imStickyBar_imCellStyleGraphics_2"></div><div id="imStickyBar_imCellStyle_2" ><div id="imStickyBar_imObjectTitle_02"><span id ="imStickyBar_imObjectTitle_02_text" >HUB</span > </div></div></div></div></div>
						</div>
					</div>
				...
				<?php echo $search->search($keys, $page, $type); ?>
					...
					<div id="imFooter">
						<div id="imFooterObjects"><div id="imFooter_imObjectTitle_02_wrapper" class="template-object-wrapper"><div id="imFooter_imCell_2" class="" > <div id="imFooter_imCellStyleGraphics_2"></div><div id="imFooter_imCellStyle_2" ><div id="imFooter_imObjectTitle_02"><span id ="imFooter_imObjectTitle_02_text" >All Rights Reserved.</span > </div></div></div></div></div>
					</div>
				</div>
